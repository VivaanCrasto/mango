...
function draw() {
  ...
  if(detectollision(stone,mango1)){
    score = score + 1;
  }
  if(detectollision(stone,mango2)){
    score = score + 1;
  }
  if(detectollision(stone,mango3)){
    score = score + 1;
  }
  if(detectollision(stone,mango4)){
    score = score + 1;
  }
  if(detectollision(stone,mango5)){
    score = score + 1;
  }
  if(detectollision(stone,mango6)){
    score = score + 1;
  }
  if(detectollision(stone,mango7)){
    score = score + 1;
  }
  if(detectollision(stone,mango8)){
    score = score + 1;
  }
  if(detectollision(stone,mango9)){
    score = score + 1;
  }
  if(detectollision(stone,mango10)){
    score = score + 1;
  }
